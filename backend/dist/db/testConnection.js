...
async function test() {
    ...
    `);
        await pool.query(`INSERT INTO users (email, password, full_name, phone, role) VALUES ($1, $2, $3, $4, $5)`, ['manual@example.com', 'manualpassword', 'Manual User', '0987654321', 'OWNER']);
