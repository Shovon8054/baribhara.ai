        ...
        <div className="min-h-[calc(100vh-64px)] bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 px-3 sm:px-6 py-4 flex items-center justify-center">
            <div className="w-full max-w-4xl h-[calc(100vh-100px)] min-h-[500px] flex flex-col bg-slate-800/40 backdrop-blur-sm rounded-2xl border border-slate-700/50 shadow-2xl overflow-hidden">
                ...
                {/* =================================
                    HEADER
                ================================= */}
                <div className="bg-slate-800/60 backdrop-blur-sm border-b border-slate-700/50 flex-shrink-0 p-3 sm:p-4">
                    <div className="flex items-center gap-3">
                        ...
                        {userLoading ? (
                            ...
                            <div className="w-10 h-10 rounded-full bg-gradient-to-br from-cyan-500 to-indigo-500 flex items-center justify-center text-white font-bold text-base shadow-lg shadow-cyan-500/20">
                    ...
                    {loading ? (
                        ...
                        <div className="flex justify-center items-center h-full">
                            <div className="text-center">
                                <div className="w-14 h-14 mx-auto rounded-full bg-slate-900/50 flex items-center justify-center mb-3 border border-cyan-500/20">
                        ...
                        <div className="space-y-3">
                                    ...
                                    >
                                        <div
                                            className={`max-w-[80%] px-4 py-2.5 rounded-2xl ${isMine
                                                    ? "bg-gradient-to-r from-cyan-500 to-indigo-500 text-white rounded-br-xs shadow-lg shadow-cyan-500/20"
                                                    : "bg-slate-800/80 text-slate-200 rounded-bl-xs border border-slate-700/50"
                                                }`}
                                        >
                                            ...
                                            <div
                                                className={`flex items-center justify-end gap-1 text-[10px] mt-1 ${isMine ? "text-cyan-100/70" : "text-slate-400"
                                                    }`}
                                            >
                            ...
                            {typing && (
                                <div className="flex justify-start animate-fadeIn">
                                    <div className="bg-slate-800/80 border border-slate-700/50 rounded-2xl rounded-bl-xs px-4 py-2.5">
                ...
                {/* =================================
                    MESSAGE INPUT BAR
                ================================= */}
                <div className="bg-slate-800/60 backdrop-blur-sm border-t border-slate-700/50 flex-shrink-0 p-3 sm:p-4">
